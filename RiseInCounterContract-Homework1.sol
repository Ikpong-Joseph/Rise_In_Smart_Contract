...
contract Example {
    ...
    /* Here's the homework 
    Add a new function to our contract.
    This will be a query function
    Just like the function that returns the number of the counter
    But this one will return the description instead.
    */
